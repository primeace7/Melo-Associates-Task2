...
const STEPS: { title: string; body: ReactNode }[] = [
  {
    ...
    body: (
      <>
        Pick <Pill>Job title</Pill> if you're typing a role like "barista", <Pill>Describe someone</Pill> if
        you're writing a few words about a specific person, or <Pill>Auto</Pill> to let the app figure out
        which one you meant.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        Enter at least 3 characters in the box. In <Pill>Job title</Pill> mode you can also tap one of the
        3 suggested pills to fill the box instantly.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        Tap <Pill tone="ink">Get compliments</Pill>. While it's thinking, you'll see some real research
        about why recognition matters at work.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        Copy any single compliment or all three at once. Tap <Pill>Escalate</Pill> on a compliment to make
        it even more over-the-top. Use <Pill>Clear</Pill> to reset, and <Pill>Restore</Pill> to bring back
  ...
  },
  {
    ...
    body: (
      <>
        Open <Pill tone="pink">Brand guidelines</Pill> to write your own numbered style/tone
        rules — up to 3 sets, up to 10 rules each — and pick one to apply to every compliment and
        escalation. Leave it on <Pill tone="pink">Default</Pill> to use the app's built-in voice.
        When a rule is followed, you'll see a small "Rules: 1, 3" badge under that compliment.
      </>
    ),
  },
];
